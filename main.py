...
class Panel(QMainWindow):
    ...
    def github(self):
        webbrowser.open('https://github.com/Beekay-exe')

    def contact(self):
        webbrowser.open("mailto:?to=bharathkumarcool2002@gmail.com&subject='Hello Bharath'", new=1)

    def social(self):
        webbrowser.open('https://www.linkedin.com/in/bharath-kumar-velpandian/')
